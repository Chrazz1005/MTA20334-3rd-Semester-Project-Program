...
class EuclideanDistance:
    ...
    heightRelation_A_min = 1.10
    heightRelation_A_max = 1.40
    heightRelation_B_min = 0.60
    heightRelation_B_max = 0.80
    heightRelation_C_min = 0.35
    heightRelation_C_max = 0.60

    verticalRatio_A_min = 100
    verticalRatio_A_max = 130
    verticalRatio_B_min = 130
    verticalRatio_B_max = 160
    verticalRatio_C_min = 240
    verticalRatio_C_max = 260

    horizontalRatio_A_min = 320
    horizontalRatio_A_max = 480
    horizontalRatio_B_min = 280
    horizontalRatio_B_max = 310
